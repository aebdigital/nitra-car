  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        {/* Content Container */}
        <div className="relative z-10 h-full flex items-center justify-start" style={{ paddingLeft: '5%' }}>
          <div className="w-full max-w-2xl px-4">
            ...
            <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/20 ring-1 ring-white/10">
              <h2 className="text-2xl font-bold text-white mb-6 text-center drop-shadow-lg">Nájdite si perfektné auto</h2>
              ...
              <form onSubmit={handleSearchSubmit} className="space-y-6">
                  ...
                  <div className="flex gap-4">
                    <div className="flex-1">
                      ...
                      <input
                        ...
                        className="w-full px-3 py-3 border border-white/30 rounded-xl focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-white/50 bg-white/20 backdrop-blur-md text-white"
                      />
                    </div>
                    <div className="w-32">
                      <label className="block text-sm font-medium text-white/90 mb-2 drop-shadow-sm">
                ...
                <div className="space-y-3">
                  <h3 className="text-sm font-medium text-white/90 mb-3 drop-shadow-sm">Doplnkové služby</h3>
                ...
                <button
                  type="submit"
                  className="w-full bg-white/20 hover:bg-white/30 backdrop-blur-md border border-white/40 text-white py-3 rounded-xl font-medium transition-all duration-200 flex items-center justify-center space-x-2 shadow-lg mt-6 hover:shadow-xl"
                >
        ...
        {/* Reviews Section - Bottom Right */}
        <div className="absolute bottom-0 right-0 z-20" style={{ bottom: '10%', right: '10%' }}>
          {/* Headings - Outside the box, side by side */}
          <div className="flex space-x-6 mb-4 justify-end">
            <h3 className="text-lg font-bold text-white drop-shadow-lg whitespace-nowrap">
              1000+ spokojných zákazníkov
            </h3>
            <p className="text-lg font-bold text-white drop-shadow-lg whitespace-nowrap">
              20 rokov skúseností
            </p>
          </div>
          
          {/* Review Container */}
          <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-6 shadow-2xl border border-white/20 ring-1 ring-white/10 max-w-sm">
            {/* Review Content */}
            <div className="space-y-3">
              ...
              <div className="text-white/90 text-sm min-h-[60px]">
